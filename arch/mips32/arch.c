...
unsigned int* const GPIO_PS2_DATA = (unsigned int*)0xbfc09010; // PS2 data register, R/W
unsigned int* const GPIO_PS2_CTRL = (unsigned int*)0xbfc09014; // PS2 control register, R/W
